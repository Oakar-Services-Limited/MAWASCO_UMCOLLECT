...
class BulkMeterReadingDialog extends StatefulWidget {
  final String accountno;
  const BulkMeterReadingDialog({super.key, required this.accountno});

  @override
  State<BulkMeterReadingDialog> createState() => _ForgetPasswordDialogState();
}

class _ForgetPasswordDialogState extends State<BulkMeterReadingDialog> {
  String meterreading = '';
  String dmaname = '';
  String meterstatus = '';
  String remarks = '';
            ...
            children: [
              ...
              SubmitButton(
                ...
                onButtonPressed: () async {
                  ...
                  var res = await submitData(widget.accountno, dmaname,
                      meterreading, meterstatus, remarks, myimage);
                  setState(() {
                    isLoading = null;
                    if (res.error == null) {
                      error = res.success;
