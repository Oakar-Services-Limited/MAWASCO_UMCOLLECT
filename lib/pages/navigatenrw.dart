...
import 'package:kiambu_umcollect/pages/filereportnrw.dart';
import 'package:url_launcher/url_launcher.dart';
import 'dart:math' show cos, sqrt, asin;
import 'dart:math' as math;
import 'package:http/http.dart' as http;

class NavigateNRW extends StatefulWidget {
  final dynamic item;
  const NavigateNRW({
    super.key,
    required this.item,
  ...
  @override
  _NavigateNRWState createState() => _NavigateNRWState();
}

class _NavigateNRWState extends State<NavigateNRW> {
  ...
  @override
  void didUpdateWidget(covariant NavigateNRW oldWidget) {
