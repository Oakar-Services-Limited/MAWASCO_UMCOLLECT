...
class Appurtenances extends StatefulWidget {
  const Appurtenances({
    super.key,
  });

  @override
  State<Appurtenances> createState() => _AppurtenancesState();
}

class _AppurtenancesState extends State<Appurtenances> {
                  ...
                  children: [
                    ...
                    type == "Reducer"
                        ? MySelectInput(
                            ...
                            label: 'Reuced Diameter',
                            value: reduceddiameter,
                          )
                        : const SizedBox(),
                    type == "Stop Cork" || type == "Connector"
                        ? MySelectInput(
                            onSubmit: (value) {
                              setState(() {
                                zone = value;
  ...
  try {
    ...
    if (editing == 'true') {
      response = await http.put(
        Uri.parse("${getUrl()}appurtenances/$appurtID"),
        ...
        body: jsonEncode(<String, dynamic>{
          ...
          'ReducedDiameter': reduceddiameter,
          'Material': material,
      ...
      response = await http.post(
        Uri.parse("${getUrl()}appurtenances/create"),
        headers: <String, String>{
          'Content-Type': 'application/json; charset=UTF-8',
        },
        body: jsonEncode(<String, dynamic>{
